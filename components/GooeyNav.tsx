...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const updateEffectPosition = (element: HTMLElement) => {
    ...
    Object.assign(glassRef.current.style, styles);
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>, index: number) => {
    ...
    if (glassRef.current) {
      glassRef.current.classList.remove('active');
      void glassRef.current.offsetWidth;
      glassRef.current.classList.add('active');
    }
    if (filterRef.current) {
  ...
  return (
    <>
      ...
      <div className="relative" ref={containerRef}>
        ...
        <span className="effect glass" ref={glassRef} />
